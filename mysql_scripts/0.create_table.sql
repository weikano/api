...
CREATE TABLE `auth_client_user` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='用户对某个接入客户端的授权信息';
...
-- ----------------------------
INSERT INTO `auth_refresh_token`(`id`,`token_id`,`refresh_token`,`expires_in`,`create_user`,`update_user`) 
VALUES ('1', '1', '2.b19923a01cf35ccab48ddbd687750408bd1cb763.31536000.1566544316', '1566544316', '1', '1'),
('2', '2', '2.cb8a3e903eecd6b74fc33c111b4a286099ace3ce.31536000.1566544978', '1566544978', '2', '2');
...
-- ----------------------------
INSERT INTO `auth_scope`(`scope_name`, `description`) VALUES ('super', '用户所有信息'),('basic', '用户基本信息');
...
-- Records of role
-- ----------------------------
INSERT INTO `role`(`role_name`,`description`) VALUES ('manager', '管理员'),('user', '普通用户');
...
CREATE TABLE `user` (
  `id` int(11) NOT NULL comment '用户ID代码生成，参考唯一ID',
...
-- Records of user
-- ----------------------------
INSERT INTO `user`(`id`,`nickname`,`mobile`,`email`,`avatar`,`bio`,`status`) 
VALUES ('1', 'admin', '110', 'admin@zifangsky.cn', 'This is avatar', 'I am admin', '1'),
	   ('2', 'zifangsky', '110', 'admin@zifangsky.cn', 'This is avatar', 'I am zifangsky', '1'),
       ('3', 'Tom', '12306', 'admin@zifangsky.cn', 'This is avatar', 'Tom and Jerry', '1');
-- 登录方式
...
values('email'),('phone'), ('account'), ('weibo'), ('wechat'), ('qq');

DROP TABLE IF EXISTS `user_auths`;
CREATE TABLE `user_auths` (
  `id` int(11) NOT NULL, 
  `user_id` int(11) NOT NULL comment '用户id',
  `identity_type_id` int(2) NOT NULL comment '登录类型',
  `identifier` varchar(100) NOT NULL comment '登录标识：手机号、邮箱、第三方唯一标识等', 
  `credential` varchar(100) NOT NULL comment '登录凭证：密码或者第三方凭证，第三方的保存token之类'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
-- ----------------------------
